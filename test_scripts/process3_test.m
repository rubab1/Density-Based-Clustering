...
for waveformNumber = 1 : numberOfWaveforms,
  ...
  unix(['convert -resize 400x400 ' waveform '_roc.eps ' ...
        waveform '_roc_small.eps']);

  % append figure to html index file
  fprintf(indexFileID, ...
          '<a href="%s_roc.eps"><img src="%s_roc_small.eps"></a>\n', ...
          waveform, waveform);
  ...
  % produce thumbnail image
  unix(['convert -resize 400x400 ' waveform '_significance.eps ' ...
        waveform '_significance_small.eps']);

  % append figure to html index file
  fprintf(indexFileID, ...
          ['<a href="%s_significance.eps">' ...
           '<img src="%s_significance_small.eps"></a>\n<br />'], ...
          waveform, waveform);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % produce thumbnail image
  unix(['convert -resize 400x400 ' waveform '_significance-falserate.eps ' ...
        waveform '_significance-falserate_small.eps']);
  
  % append figure to html index file
  fprintf(indexFileID, ...
          ['<a href="%s_significance-falserate.eps">' ...
           '<img src="%s_significance-falserate_small.eps"></a>\n'], ...
          waveform, waveform);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % produce thumbnail image
  unix(['convert -resize 400x400 ' waveform '_significance-efficiency.eps ' ...
        waveform '_significance-efficiency_small.eps']);

  % append figure to html index file
  fprintf(indexFileID, ...
          ['<a href="%s_significance-efficiency.eps">' ...
           '<img src="%s_significance-efficiency_small.eps"></a>\n<br />'], ...
          waveform, waveform);
